...
{
    public class InMemoryDataStoreRoundtripTests
    {
        ...
        public void ShouldRoundtripStringType(string value)
        {
            ...
            _store.Save(data);
            var result = new InMemoryDataStore().Load<SampleData>();
        ...
        public void ShouldRoundtripMultipleTypes()
        {
            ...
            var retrievedSampleData = new InMemoryDataStore().Get<SampleData>();
            var retrievedOtherData = new InMemoryDataStore().Get<OtherData>();
